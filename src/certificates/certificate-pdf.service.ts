...
export class CertificatePdfService {
  ...
  private drawHeader(doc: PDFDocumentType, width: number): void {
    ...
    doc.circle(logoX, logoY, logoRadius).fill('#2563EB');
    ...
    doc
      ...
      .fontSize(14)
      .fillColor('#1E40AF')
      .text('ICS E-LEARNING PLATFORM', 0, logoY + 45, {
        width,
        align: 'center',
      });
  }
  ...
  private drawRecipientName(
    ...
    doc
      .moveTo(width / 2 - nameWidth / 2 - 20, underlineY)
      .lineTo(width / 2 + nameWidth / 2 + 20, underlineY)
      .lineWidth(1)
      .stroke('#CBD5E1');
  }

  private drawCompletionText(
    doc: PDFDocumentType,
    width: number,
    courseName: string,
  ): void {
    doc
      ...
      .fontSize(12)
      .fillColor('#64748B')
      .text('has successfully completed the course', 0, 345, {
        width,
        align: 'center',
      });
  ...
  private drawDetails(
    ...
    doc
      ...
      .fontSize(10)
      .fillColor('#64748B')
      .text('Date of Completion', colWidth, detailsY, {
        width: colWidth,
        align: 'center',
      });
    ...
    doc
      ...
      .fontSize(16)
      .fillColor('#1E293B')
      .text(this.formatDate(data.completionDate), colWidth, detailsY + 15, {
        width: colWidth,
        align: 'center',
      });
    ...
    if (data.duration !== undefined) {
      doc
        ...
        .fontSize(10)
        .fillColor('#64748B')
        .text('Duration', colWidth * 2, detailsY, {
          width: colWidth,
          align: 'center',
        });
      ...
      doc
        ...
        .fontSize(16)
        .fillColor('#1E293B')
        .text(`${data.duration} hours`, colWidth * 2, detailsY + 15, {
          width: colWidth,
          align: 'center',
        });
    }
  ...
  private drawSignatures(
    ...
    doc
      .moveTo(leftSigX - sigWidth / 2, signatureY)
    ...
    doc
      ...
      .fontSize(12)
      .fillColor('#1E293B')
      .text(instructorName, leftSigX - sigWidth / 2, signatureY + 8, {
        width: sigWidth,
        align: 'center',
      });
    ...
    doc
      ...
      .fontSize(10)
      .fillColor('#64748B')
      .text('Course Instructor', leftSigX - sigWidth / 2, signatureY + 25, {
        width: sigWidth,
        align: 'center',
      });
    ...
    doc
      .moveTo(rightSigX - sigWidth / 2, signatureY)
    ...
    doc
      ...
      .fontSize(12)
      .fillColor('#1E293B')
      .text('ICS Academy', rightSigX - sigWidth / 2, signatureY + 8, {
        width: sigWidth,
        align: 'center',
      });
    ...
    doc
      ...
      .fontSize(10)
      .fillColor('#64748B')
      .text('Platform Director', rightSigX - sigWidth / 2, signatureY + 25, {
        width: sigWidth,
        align: 'center',
      });
  }
  ...
  private drawFooter(
    ...
    doc
      ...
      .fontSize(9)
      .fillColor('#94A3B8')
      .text(`Certificate ID: ${certificateNumber}`, 0, footerY, {
        width,
        align: 'center',
      });
    ...
    doc
      ...
      .fillColor('#CBD5E1')
      .text(
        'Verify this certificate at: https://ics-elearning.com/verify',
        0,
        footerY + 15,
        { width, align: 'center' },
      );
