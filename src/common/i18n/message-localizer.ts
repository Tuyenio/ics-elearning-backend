...
const DICTIONARY: DictionaryEntry[] = [
  ...
  {
    vi: 'Ban chi co the cap nhat du lieu cua ban',
    en: 'You can only update your own data',
  },
  {
    vi: 'Ban chi co the xoa du lieu cua ban',
    en: 'You can only delete your own data',
  },
  ...
  {
    vi: 'Danh muc voi ten hoac slug nay da ton tai',
    en: 'A category with this name or slug already exists',
  },
  {
    vi: 'Danh muc voi ten nay da ton tai',
    en: 'A category with this name already exists',
  },
  {
    vi: 'Danh muc voi slug nay da ton tai',
  ...
  {
    vi: 'Da dang ky khoa hoc nay roi',
  ...
  {
    vi: 'Khoa hoc da co trong danh sach yeu thich',
    en: 'Course is already in wishlist',
  },
  { vi: 'Dang nhap that bai', en: 'Login failed' },
  {
    vi: 'Email hoac mat khau khong chinh xac',
  ...
  {
    vi: 'Da tai len tai lieu thanh cong',
    en: 'Document uploaded successfully',
  },
  {
    vi: 'Da tai len anh dai dien thanh cong',
  ...
  {
    vi: 'Muc lich hoc da duoc xoa thanh cong',
    en: 'Schedule item deleted successfully',
  },
  {
    vi: 'Bai tap da duoc nop roi',
    en: 'Assignment has already been submitted',
  },
  { vi: 'Han nop bai tap da het', en: 'Assignment deadline has passed' },
  { vi: 'Bai nop khong tim thay', en: 'Submission not found' },
  {
    vi: 'Khong tim thay de thi da trich xuat',
    en: 'Extracted exam was not found',
  },
  { vi: 'Khong tim thay luot thi', en: 'Attempt not found' },
  {
    vi: 'Ban khong co quyen xem luot lam cua de thi nay',
    en: 'You do not have permission to view attempts of this exam',
  },
  {
    vi: 'Ban khong co quyen xem chi tiet luot thi nay',
    en: 'You do not have permission to view this attempt detail',
  },
  {
    vi: 'Bai thi that can chon chung chi',
    en: 'Official exam requires a certificate template',
  },
  ...
  {
    vi: 'Bai kiem tra phai co it nhat mot cau hoi',
    en: 'Quiz must have at least one question',
  },
  { vi: 'Danh gia khong tim thay', en: 'Review not found' },
  {
    vi: 'Ban da danh gia khoa hoc nay roi',
    en: 'You have already reviewed this course',
  },
  {
    vi: 'Ban chi co the cap nhat danh gia cua minh',
    en: 'You can only update your own review',
  },
  {
    vi: 'Ban chi co the xoa danh gia cua minh',
    en: 'You can only delete your own review',
  },
  {
    vi: 'Khong co quyen xem ket qua bai thi',
    en: 'You do not have permission to view exam results',
  },
  { vi: 'Khong the tai ket qua bai thi', en: 'Unable to load exam result' },
  { vi: 'Yeu cau khong hop le', en: 'Bad request' },
  {
    vi: 'Ban chua dang nhap hoac phien da het han',
    en: 'You are not signed in or your session has expired',
  },
  {
    vi: 'Qua nhieu yeu cau. Vui long thu lai sau',
...
export function localizeMessage(
  ...
  if (
    /failed to fetch|network error|econnrefused|cannot connect/.test(
      normalizedMessage,
    )
  ) {
    return language === 'en'
  ...
  if (
    /unauthorized|not authenticated|invalid credentials|token/.test(
      normalizedMessage,
    )
  ) {
    return language === 'en'
  ...
  if (
    /forbidden|insufficient permissions|access denied/.test(normalizedMessage)
  ) {
    return language === 'en'
...
export function localizePayloadMessages<T>(
  payload: T,
  language: SupportedLanguage,
): T {
