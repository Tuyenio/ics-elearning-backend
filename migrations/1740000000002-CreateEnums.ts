...
export class CreateEnums1740000000002 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Set search_path to public to ensure enums are created in public schema
    await queryRunner.query('SET search_path TO public, learning');
    ...
    // Reset search_path back to learning,public so subsequent migrations create objects in learning schema
